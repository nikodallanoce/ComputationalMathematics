...
[X_hat, y_hat, w, w_star] = build_matrices("../datasets/ML-CUP21-TR.csv", 1e-0);
[f_lls, grad_lls] = build_lls(X_hat, y_hat);
rmpath ../utilities;

% Compute the solution using L-BFGS
w = zeros(size(w));
%[w_our, k, residuals, errors, p_errors] = LBFGS(w, f_lls, grad_lls, X_hat, y_hat, 10, 1e-14, true, true, w_star);
[w_our, k, residuals, errors] = LBFGS_risto(w, f_lls, grad_lls, X_hat, y_hat, 10, 1e-14, true, w_star);
